...
<center>
    ...
    <table style="margin: 0 auto;">
      ...
      <tr>
        <td>Sundae De Manjar Blanco</td>
        <td>MCflurry Oreo</td>
        <td>Tarta de Freza</td>
        <td>Torta de Selva Negra</td>
        
      </tr>
      <tr>
		<td><img src="img/SundaeDeManjarBlanco.jpg" WIDTH=178 HEIGHT=180></td>
		<td><img src="img/MCflurryOreo.jpg" WIDTH=178 HEIGHT=180></td>
		<td><img src="img/TartadeFreza.jpg" WIDTH=178 HEIGHT=180></td>
		<td><img src="img/TortadeSelvaNegra.jpg" WIDTH=178 HEIGHT=180></td>
    
  </tr>
	  <tr> 
	    <td>Volcan de Limon</td>
        <td>Helado de Vainilla</td>
        <td>Ensalada de Frutas</td>
        <td>Hot Caramel Sundae</td>
      </tr>
